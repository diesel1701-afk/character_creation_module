...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'Воитель':
        print(f'{char_name} нанёс противнику урон, равны1й '
              f'{5 + randint(3, 5)}')
    if char_class == 'Маг':
        print(f'{char_name} нанёс противнику урон, равный '
              f'{5 + randint(5, 10)}')
...
def defence(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'Лекарь':
        print('{char_name} блокировал {10 + randint(2, 5)} урона')


def special(char_name: str, char_class: str) -> str:
    """Special skill."""
    if char_class == 'Воитель':
        print(f'{char_name} применил '
